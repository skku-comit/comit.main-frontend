  ...
  return (
    <section className="relative overflow-hidden py-24">
      ...
      <div ref={containerRef} className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-2 lg:gap-6 md:grid-cols-3 md:mb-12">
          {reviews.map((review, index) => (
            ...
            >
              <div className="relative z-10 rounded-2xl border border-gray-800 bg-gray-900/50 px-4 py-6 sm:p-8 backdrop-blur-sm transition-all duration-300 hover:border-gray-700">
                ...
                <div className="relative">
                  <p className="mb-6 text-gray-300 break-keep text-sm sm:text-base">&apos;{review.content}&apos;</p>
                  <div className="flex items-center gap-4">
                    <div className="relative sm:size-12 size-10 overflow-hidden rounded-full bg-gray-800">
                      <Image src={review.image} alt={review.author} fill className="object-cover" />
                    </div>
                    <div>
                      <div className="text-sm sm:text-base font-medium text-white">{review.author}</div>
