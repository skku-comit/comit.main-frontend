...
export default function InformSection() {
    return (
        <div className="relative w-full md:w-[calc(100%-80px)] md:mx-auto py-[100px] md:py-[140px] xl:py-0 h-auto xl:h-[948px] flex flex-col-reverse md:flex-row items-center justify-center">
            <div key='text-container' className="text-white flex flex-col md:max-w-[60vw] w-[calc(100%-80px)] md:w-[50vw] xl:w-[600px]">
                <div key='main-heading' className="text-[6.2vw] xs:text-[28px] md:!text-[3.6vw] xl:!text-[48px] font-bold leading-[1.3] text-white">국내 최대 규모 IT 창업 동아리<br />사단법인 멋쟁이사자처럼이<br />운영합니다.</div>
