  ...
  return (
    <div className="relative h-[calc(100vh-4rem)]">
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 right-0 z-10 h-[120px] bg-gradient-to-t from-fuchsia-700/80 via-purple-800/30 to-transparent"
      ></motion.div>
      ...
      <section className="flex h-full w-[100vw] bg-black">
        ...
        <div key="MainElement" className="relative mb-[2vh] flex items-center">
          ...
          >
            ...
            {/* Main Heading */}
            <h1 className="mb-6 text-4xl font-bold tracking-tighter text-white sm:text-6xl lg:text-[85px]">
            ...
            {/* Sub Heading */}
            <p className="text-bold mt-6 max-w-3xl text-[22px]/[1.3] tracking-tighter text-gray-300">
              코밋이기에 제공할 수 있는 학내 최고의 학습 커뮤니티.
              <br />
            ...
            <div className="mt-6 flex flex-col gap-3 text-sm sm:flex-row">
              ...
              >
                지원하기
                <ArrowRightIcon className="-mr-1 ml-1 h-4 w-4" />
              </Link>
              <Link
                href="/about"
        ...
        <div className="flex h-full w-full items-center justify-center">
          ...
          <motion.div
            ...
            className="relative flex items-center pb-[8%] pr-[4%]"
          >
            <div className="w-[450px] overflow-hidden rounded-xl border border-gray-800 bg-gray-900/50 backdrop-blur-sm">
              {/* 에디터 헤더 */}
